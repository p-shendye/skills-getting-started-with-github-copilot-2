              ...
              .map(
                (participant) => `
                  <div class="participant-row">
                    ...
                    <button type="button" class="delete-participant-btn" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant} from ${name}" title="Unregister ${participant}">
                      🗑️
                    </button>
                  </div>
                `
